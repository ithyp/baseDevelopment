class VisionKit  {
    ...
    isSameNodeType(node, vnode) {
      if (node.nodeType===3) return this.isString(vnode);
      let nodeName = vnode.nodeName;
      if (this.isFunction(nodeName)) return node._componentConstructor===nodeName;
      return node.nodeName.toLocaleLowerCase()===nodeName;
    }
